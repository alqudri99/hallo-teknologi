...
import com.alqudri.hallotechnology.model.DataItem
import com.bumptech.glide.Glide
import kotlinx.android.synthetic.main.content_categories.view.*

class MerekAdapter(var onItemClick: OnItemClick, var position: Int, var data: List<DataItem>) : RecyclerView.Adapter<MerekAdapter.ViewHolder>(){
    inner class ViewHolder(var view: View): RecyclerView.ViewHolder(view) {
        fun bind(dat: DataItem){

            if (this@MerekAdapter.position == position && this@MerekAdapter.position != 1000){
